...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://telegra.ph/file/69e16ce80ffacd0f2b588.jpg")
WELCOM_TEXT = environ.get("WELCOM_TEXT", "𝙷𝙴𝙻𝙻𝙾 {user}\nwelcome to {chat}")
